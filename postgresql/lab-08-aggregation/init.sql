-- Lab 08: ข้อมูลสำหรับฝึก Aggregation (reuse + extend จาก Lab 07)
...
-- Orders (different dates for monthly analysis)
INSERT INTO orders (user_id, total, status, created_at) VALUES
  ...
  (5, 52800, 'completed', '2024-02-20'),
  (1, 69900, 'completed', '2024-03-05'),
  (3, 9900, 'pending', '2024-03-10'),
  (5, 42900, 'completed', '2024-03-15');
